...
import com.yusudhanwinwin.winwin.SpinWheel.LuckyItem;
import com.yusudhanwinwin.winwin.SpinWheel.LuckyWheelView;
import com.yusudhanwinwin.winwin.databinding.ActivitySpinnerBinding;
...
public class SpinnerActivity extends AppCompatActivity {
        ...
        binding.spinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentSpin > 0) {
                    ...
                    Toast.makeText(SpinnerActivity.this, "You have no spins left.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void loadCoins() {
        reference.child(user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                currentSpin = model.getSpins(); // currentSpin değerini güncelleyin
                binding.currentSp.setText(String.valueOf(currentSpin)); // currentSpin değerini ekrana yazdırın
            }
    ...
    private void updateCoins(String value) {
        ...
        int updatedCoins = currentCoins + Integer.parseInt(value);
        int updatedSpin = currentSpin - 1; // her çevirmede spin hakkını azalt
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            binding.currentSp.setText(String.valueOf(updatedSpin)); // Güncellenen spin değerini ekrana yazdırın.
                        }else{
