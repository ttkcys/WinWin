...
import com.yusudhanwinwin.winwin.Adapters.TrAdapter;
import com.yusudhanwinwin.winwin.Models.TrModel;
import com.yusudhanwinwin.winwin.R;
import com.yusudhanwinwin.winwin.databinding.ActivityTrHistoryBinding;
...
public class TrHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.redeemRecy.setLayoutManager(manager);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(snapshot.exists()){
                            ...
                            binding.redeemRecy.setAdapter(adapter);
                        }
                    }
